...
3. **Reference requirements and hypotheses.** Use REQ-* identifiers (from docs/REQUIREMENTS.md) and H1-H6 hypothesis criteria (from docs/ROADMAP.md) when describing quality criteria and changelog entries.
